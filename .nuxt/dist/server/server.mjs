...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BL9UGsxn.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CIq2hIwM.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DWjo27cZ.js").then((r) => r.default || r));
