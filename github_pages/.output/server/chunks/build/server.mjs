import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, useSSRContext, mergeProps, defineAsyncComponent, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from 'vue';
import { h as createHooks, i as getContext, k as hasProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, m as isScriptProtocol, n as createError$1, t as toRouteMatcher, o as createRouter, p as defu, q as isEqual, r as stringifyParsedURL, v as stringifyQuery, x as parseQuery } from '../nitro/nitro.mjs';
...
const router_nyHnpG4Kcu7grL1XzG3WOz1uk6bhVbqQBCR60aAjprg = defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4b3f113f"]]);
