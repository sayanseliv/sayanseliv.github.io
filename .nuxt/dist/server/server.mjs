...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-Do700ak5.js").then((m) => m.default || m)
  }
];
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-2c57a8af><nav class="container-1440 header__nav" data-v-2c57a8af>Header</nav></header>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-2c57a8af"]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Dm18XUA1.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DDH-rby9.js").then((r) => r.default || r));
