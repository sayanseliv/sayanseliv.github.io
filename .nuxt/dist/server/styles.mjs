...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.MBZ105Df.mjs').then(interopDefault),
  ...
  "components/UI/Sidebar.vue": () => import('./_nuxt/Sidebar-styles.DBNuBI-I.mjs').then(interopDefault),
  ...
  "components/UI/Sidebar.vue?vue&type=style&index=0&scoped=7bb91a7c&lang.scss": () => import('./_nuxt/Sidebar-styles.DBNuBI-I.mjs').then(interopDefault),
